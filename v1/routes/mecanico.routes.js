...
router.post('/', authenticateMiddleware, rolAuthMiddleware(['taller']), crearMecanico);
router.get('/:id', authenticateMiddleware, rolAuthMiddleware(['taller']), obtenerMecanicoPorId);
router.put('/:id', authenticateMiddleware, rolAuthMiddleware(['taller']), modificarMecanico);
