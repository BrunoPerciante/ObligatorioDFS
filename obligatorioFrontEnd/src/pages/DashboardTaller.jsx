...
export default function DashboardTaller() {
  ...
  const refrescarMantenimientos = () =>
    setRecargarMantenimientos((prev) => prev + 1); // ← ídem
    ...
    <div className="page active">
      <nav>
        ...
        <div className="nav-links">
          ...
          <button
            className={seccion === "mecanicos" ? "active" : ""}
            onClick={() => setSeccion("mecanicos")}
          >
            Mecánicos
          </button>
          <button
      ...
      <div className="dashboard-layout">
        <div className="sidebar">
          <div className="sidebar-section">
            ...
            <button
              className={`sidebar-btn ${seccion === "mecanicos" ? "active" : ""}`}
              onClick={() => setSeccion("mecanicos")}
            >
